...
@section('content')
    ...
    <div class="container mt-5">
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="col-8 mx-auto">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('stock') is-invalid @enderror" id="harga" name="harga" value="{{ old('harga') }}">
